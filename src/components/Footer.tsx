...
import img1 from "../../public/product detail/Frame53.png"
import img2 from "../../public/footer/1.png"
import img3 from "../../public/footer/2.png"
import img4 from "../../public/footer/3.png"
import img5 from "../../public/footer/4.png"

export default function Footer() {
  return (
<div>
<div className="relative top-20 block px-12 py-10 space-y-5 md:flex justify-around items-center border-2 mt-10 mx-auto rounded-2xl w-[400px] sm:w-[500px] sm:h-[300px] md:w-[1300px] md:h-[200px]  bg-black">
  <div className="font-extrabold text-4xl text-white sm:w-[400px] md:w-[600px]">
